...
graphs `1.png` is each path between causal and outcome variable
(nodes). It is used to check whether the backdoor criterion is satified and
give a set of variables to condition on, so causal relationship can be
determined.
